...
-- query name: Average & Median TVL by User EUTBL
-- query link: https://dune.com/queries/6743237


-- ============================================================
-- Average + Median TVL per Holder — EUTBL
...
-- NAV price — Ethereum mainnet (6 decimals, EUR)
nav_raw AS (
...
SELECT
    ...
    COUNT(*)                                                               AS "Holders",
    ROUND(SUM(net_balance * p * fx), 0)                                    AS "Total EUTBL TVL (USD)",
