...
-- query name: eurSPKCC TVL by User
-- query link: https://dune.com/queries/6706775


-- ============================================================
-- eurSPKCC — TVL by User | All Chains
...
evm_transfers AS (
    ...
    WHERE evt_block_time >= TIMESTAMP '2024-04-30'
      ...
      AND contract_address IN (
          0x3868D4e336d14D38031cf680329d31e4712e11cC,  -- Ethereum/Etherlink
          0x99F70A0e1786402a6796c6B0AA997ef340a5c6da,  -- Polygon
          0x0e389C83Bc1d16d86412476F6103027555C03265,  -- Arbitrum
          0x4f33aCf823E6eEb697180d553cE0c710124C8D59   -- Base
      )
),
evm_balances AS (
...
stellar_balances AS (
    ...
    FROM (
        ...
        WHERE contract_id = 'CDWOB6T7SVSMMQN5V3P2OPTBAXOP7DAZHGVW3PYTZIKHVFKN6TBSXR6A'
          AND deleted = false
