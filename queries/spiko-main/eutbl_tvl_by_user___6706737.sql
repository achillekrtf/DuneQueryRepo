...
-- query name: EUTBL TVL by User
-- query link: https://dune.com/queries/6706737


-- ============================================================
-- EUTBL — TVL by User | All Chains
...
evm_transfers AS (
    ...
    WHERE evt_block_time >= TIMESTAMP '2024-04-30'
      ...
      AND contract_address IN (
          0xa0769f7A8fC65e47dE93797b4e21C073c117Fc80,  -- Eth/Poly/Base/Etherlink
          0xCBeb19549054CC0a6257A77736FC78C367216cE7   -- Arbitrum
      )
),
evm_balances AS (
...
stellar_balances AS (
    ...
    FROM (
        ...
        WHERE contract_id = 'CBGV2QFQBBGEQRUKUMCPO3SZOHDDYO6SCP5CH6TW7EALKVHCXTMWDDOF'
          AND deleted = false
